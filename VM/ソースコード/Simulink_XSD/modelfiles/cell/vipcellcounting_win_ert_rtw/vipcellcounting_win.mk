...
MODEL                = vipcellcounting_win
MODULES              = HostLib_MMFile.c HostLib_Multimedia.c HostLib_Video.c HostLib_rtw.c rtGetInf.c rtGetNaN.c rt_nonfinite.c ssprintf_rt.c vipcellcounting_win_data.c vipdrawtext_main_rt.c 
MAKEFILE             = vipcellcounting_win.mk
...
MODELLIB                  = vipcellcounting_winlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = vipcellcounting_win_ref.rsp
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	...
	-I$(MATLAB_ROOT)/toolbox/shared/multimedia/include \
	-I$(START_DIR)/vipcellcounting_win_ert_rtw \
	-I$(START_DIR) \
...
%.obj : $(MATLAB_ROOT)/toolbox/vision/extern/vipdrawtext/%.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $<
